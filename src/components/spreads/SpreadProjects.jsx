    ...
    if (projectIndex === 0) {
      ...
      return (
        <div className="w-full h-full bg-[#151310] flex flex-col justify-between p-6 text-[#F5F1EB] border border-[#D1B48C]/20 select-none">
          <div className="flex justify-between items-start">
            <span className="font-meta text-[9px] tracking-widest text-[#D1B48C]">INGESTION PIPELINE</span>
          ...
          <div className="my-auto flex flex-col items-center gap-4 text-center">
            ...
            <svg viewBox="0 0 100 100" className="w-24 h-24 stroke-[#D1B48C] stroke-[0.75] fill-none opacity-90 animate-pulse">
              <circle cx="50" cy="50" r="40" strokeDasharray="3 3" />
              <circle cx="50" cy="50" r="24" />
              <rect x="38" y="38" width="24" height="24" strokeDasharray="2 1" />
              <line x1="10" y1="50" x2="90" y2="50" />
              <line x1="50" y1="10" x2="50" y2="90" />
              <circle cx="50" cy="50" r="3" fill="#DC684A" stroke="none" />
            </svg>
            <h4 className="font-heading italic text-2xl text-[#D1B48C] mt-2">RetailMind</h4>
      ...
      return (
        <div className="w-full h-full bg-[#1D1915] flex flex-col justify-between p-6 text-[#F5F1EB] border border-[#D1B48C]/20 select-none">
          <div className="flex justify-between items-start">
            <span className="font-meta text-[9px] tracking-widest text-[#D1B48C]">TACTILE DESIGN</span>
          ...
          <div className="my-auto flex flex-col items-center gap-4 text-center">
            ...
            <svg viewBox="0 0 100 100" className="w-24 h-24 stroke-[#D1B48C] stroke-[0.75] fill-none opacity-90">
              <rect x="15" y="22" width="70" height="56" rx="2" />
              <line x1="50" y1="22" x2="50" y2="78" strokeWidth="1" stroke="#DC684A" />
  ...
  return (
    <div className="page-spread-content h-full bg-[#F5F1EB] p-12 text-[#1A1916]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1.3fr] gap-10 my-auto py-6 items-stretch">
        ...
        <div className="flex flex-col justify-center border-b md:border-b-0 md:border-r border-[#1A1916]/10 pb-6 md:pb-0 pr-0 md:pr-6">
        ...
        <div className="flex flex-col justify-between pl-0 md:pl-2">
          ...
          <div className="flex flex-col gap-2">
            <span className="font-meta text-[9px] tracking-[0.2em] text-[#DC684A] uppercase block font-bold mb-1 select-none">
              {project.type}
            </span>
            <h3 className="font-heading italic font-light text-[36px] leading-[0.95] text-[#1A1916] select-none">
              {project.title}
            </h3>
            
            <p className="font-body text-[13px] leading-relaxed text-[#383530] mt-3 select-text">
              {project.desc}
            </p>
          </div>

          {/* Details footer */}
          <div className="my-6 pt-4 border-t border-[#1A1916]/10 flex flex-wrap gap-x-8 gap-y-4 select-none">
            <div className="flex flex-col">
              <span className="font-meta text-[8.5px] tracking-widest text-[#7A746B] uppercase mb-1">YEAR</span>
              <span className="font-display font-bold text-xs text-[#1A1916]">{project.year}</span>
            </div>
            <div className="flex flex-col max-w-[210px]">
              <span className="font-meta text-[8.5px] tracking-widest text-[#7A746B] uppercase mb-1">TECH STACK</span>
              <span className="font-meta text-[9.5px] text-[#383530] leading-normal font-medium">{project.tech}</span>
            </div>
          </div>
          ...
          <div className="flex gap-4 select-none">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-meta text-[9.5px] tracking-widest text-[#F5F1EB] bg-[#1A1916] hover:bg-[#DC684A] px-4 py-2.5 transition-colors duration-300 font-semibold uppercase rounded-[9999px]"
            >
              EXECUTE PAYLOAD ↗
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-meta text-[9.5px] tracking-widest text-[#1A1916] hover:text-[#D1B48C] border border-[#1A1916]/20 hover:border-[#D1B48C] px-4 py-2.5 transition-colors duration-300 font-semibold uppercase rounded-[9999px]"
            >
              VIEW SOURCE
            </a>
          </div>
