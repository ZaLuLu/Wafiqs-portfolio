        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1.3fr] gap-10 my-auto py-6 items-stretch">
          ...
          <div className="flex flex-col justify-center border-b md:border-b-0 md:border-r border-[#1A1916]/10 pb-6 md:pb-0 pr-0 md:pr-6">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0D0C0A]/95 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center p-4">
                <Caption><span className="text-[#F5F1EB] font-semibold">Open Dossier Details →</span></Caption>
              </div>
            </motion.div>
          ...
          <div className="flex flex-col justify-between pl-0 md:pl-2">
            <div className="flex flex-col gap-3">
              <span className="font-meta text-[9px] tracking-[0.2em] text-[#DC684A] uppercase font-bold block">
                DEVELOPER DOSSIER
              </span>
              <h3 className="font-heading italic font-light text-[34px] leading-tight text-[#1A1916]">
                Discipline &amp; Craft
              </h3>
              <p className="font-body text-[13px] leading-relaxed text-[#383530] mt-2">
                {ABOUT.bio}
              </p>
            </div>
            ...
            <div className="my-6">
              <ul className="flex flex-col gap-2">
                <li className="flex justify-between items-baseline border-b border-[#1A1916]/10 pb-1.5 text-xs">
                  <span className="font-meta text-[10px] text-[#7A746B] uppercase">Degree</span>
                  <span className="font-display font-bold text-[#1A1916]">{IDENTITY.classLabel}</span>
                </li>
                <li className="flex justify-between items-baseline border-b border-[#1A1916]/10 pb-1.5 text-xs">
                  <span className="font-meta text-[10px] text-[#7A746B] uppercase">University</span>
                  <span className="font-display font-medium text-[#1A1916]">Svyasa University</span>
                </li>
                <li className="flex justify-between items-baseline text-xs">
                  <span className="font-meta text-[10px] text-[#7A746B] uppercase">Status</span>
                  <span className="font-display font-bold text-[#DC684A] uppercase tracking-wider">{IDENTITY.statusBadge}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="select-none flex gap-4">
              <button
                onClick={() => setProfileOpen(true)}
                className="font-meta text-[10px] tracking-widest text-[#F5F1EB] bg-[#1A1916] hover:bg-[#DC684A] px-5 py-3 transition-colors duration-300 font-semibold uppercase rounded-[9999px] border-none cursor-pointer"
              >
                OPEN DOSSIER →
              </button>
            </div>
